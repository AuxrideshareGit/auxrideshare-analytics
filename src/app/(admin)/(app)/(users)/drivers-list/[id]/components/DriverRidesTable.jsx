...
const DriverRidesTable = ({ driverId }) => {
  ...
  useEffect(() => {
    const fetchRides = async () => {
      ...
      try {
        ...
        const result = await apiFetch(`/api/v1/admin/drivers/${driverId}/rides/?${queryParams}`, { token });
  ...
  }, [driverId, page, limit, search, status, vehicleType, preorder, hasCouponApplied, rideType, startDate, endDate, dateField, sortBy, order, token]);
              ...
              <table className="min-w-full divide-y divide-default-200">
                <thead className="bg-default-150 sticky top-0 z-20 shadow-sm backdrop-blur-md">
                  <tr className="text-sm font-normal text-default-700 whitespace-nowrap">
                    ...
                    <th className="px-3.5 py-3 text-start">Rider Name</th>
                  ...
                  {loading ? (
                    ...
                    <tr>
                      <td colSpan="13" className="py-10 text-center text-default-500">
                        No driver requests found matching criteria.
                      </td>
                    </tr>
                  ) : (
                    data.map((request) => (
                      ...
                      >
                        ...
                        <td className="px-3.5 py-3">
                          {request.rider_info ? (
                            <span className="font-semibold text-default-800">{request.rider_info.name || 'Unknown'}</span>
                          ) : (
